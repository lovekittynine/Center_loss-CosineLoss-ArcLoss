...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 20 14:10:00 2018

@author: wsw
"""

# train mnist with angular loss

import tensorflow as tf
import matplotlib.pyplot as plt
from mpl_toolkits.mplot3d import Axes3D
from Dataset import make_dataset
from Angular_loss import get_angular_loss
import os
import time
import numpy as np
...
def display_fig(features,targets,epoch):
  if not os.path.exists('./angular_loss_images'):
    os.makedirs('./angular_loss_images')
  ...
  fig.savefig('./angular_loss_images/%d.png'%epoch)
  plt.close(fig)
...
def train():
  ...
  with tf.name_scope('angular_loss'):
    loss = get_angular_loss(logits,ys,s=64,m=0.5)
